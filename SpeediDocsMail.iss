...
Source: Styles\BlueGraphite.vsf; DestDir: {app}; Flags: dontcopy
...
[Registry]
; outlook entries
Root: HKCU; Subkey: "SOFTWARE\Microsoft\Office\Outlook\Addins\Insight_Addin_for_Outlook"; Flags: uninsdeletekey; ValueType: dword; \
   ValueName: "LoadBehavior"; ValueData: "3";
Root: HKCU; Subkey: {{Code:BuildOutlookResiliencyKey}; Flags: uninsdeletekey; ValueType: dword; \
    ValueName: "Insight_Addin_for_Outlook"; ValueData: "1"; 
...
//  LoadSkin(ExpandConstant('{tmp}\Office2007.cjstyles'), '');
  ExtractTemporaryFile('BlueGraphite.vsf');
  LoadVCLStyle(ExpandConstant('{tmp}\BlueGraphite.vsf'));
  ...
  begin
    ...
    begin
      if MsgBox('Version ' + oldVersion + ' of SpeediDocsMail is already installed. Continue to use this version?',
    ...
    begin
      MsgBox('Version ' + oldVersion + ' of SpeediDocsMail is already installed. Please uninstall and then retry installation. The installer will now exit.',
        mbInformation, MB_OK);
      Result := False;
    end;
  end
